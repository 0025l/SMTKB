...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Buat Tim Baru</h2>
        ...
        <form action="{{ route('tim.store') }}" method="post">
                ...
                <div class="form-group">
                    <label for="nama">Jenis Tim:</label>
                    <select name="jenis_tim" class="form-control">
                      <option>...</option>
                      <option value="RHA">RHA</option>
                      <option value="TRC">TRC</option>
                      <option value="Tim Bantuan Kesehatan">Tim Bantuan Kesehatan</option>
                    </select>
                </div>
                <div class="form-group">
