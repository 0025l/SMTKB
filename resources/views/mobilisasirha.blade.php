...
<html lang="en">
  ...
  <body id="page-top">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown no-arrow">
              ...
              <a class="dropdown-item" href="{{route('mobilisasirha')}}">TIM RHA</a>
            <a class="dropdown-item" href="{{route('mobilisasitrc')}}">TIM Reaksi Cepat</a>
            <a class="dropdown-item" href="{{route('mobilisasitbk')}}">Tim Bantuan Kesehatan</a>
            </div>
        </li>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Mobilisasi Tim RHA</h2>
