...
<html lang="en">
  ...
  <head>
    ...
    <title>TITAN - Edit Data Relawan</title>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Edit Data Relawan</h2>
            ...
            <form action="{{ route('relawan.update', $data->id_relawan) }}" method="POST">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="form-group">
                    <label for="id_relawan">NIK:</label>
                    <input type="text" class="form-control" name="id_relawan" value="{{ $data->id_relawan }}">
                </div>
                <div class="form-group">
