...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" src="/assets/manager.png" alt="">
        <h1 class="text-uppercase mb-0">Selamat Datang </h1>
        <hr class="star-light2">
        <h2 class="font-weight-light mb-0">Staff Pengelola</h2>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3">
            <a class="portfolio-item d-block mx-auto" href="{{ route('kelola') }}">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
              <img style="align-items: right; align-content: right;" class="img-fluid" src="/assets/volunteer.png" alt="">
            
         
          </div><div class="col-md-6 col-lg-3" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Kelola Data Relawan</div> 
          </a>
          <div class="col-md-6 col-lg-3">
            <a class="portfolio-item d-block mx-auto" href="{{ route('tabelbencana') }}">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <i class="fas fa-search-plus fa-3x"></i>
                </div>
              </div>
              <img class="img-fluid" src="/assets/forest-fire.png" alt="">
           
          </div><div class="col-md-6 col-lg-3" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Kelola Data Bencana</div>  </a>
